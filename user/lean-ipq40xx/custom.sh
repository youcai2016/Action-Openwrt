...
sed  "44i echo ' ' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
sed  "45i echo 'src/gz openwrt_all https://openwrt.download/ExtraPackages/all' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
sed  "46i echo 'src/gz openwrt_ipk https://openwrt.download/ExtraPackages/arm_cortex-a7_neon-vfpv4' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
