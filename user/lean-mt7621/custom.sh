...
sed -i "s/https:/R21.0.0/g"  package/lean/default-settings/files/zzz-default-settings
...
sed -i  "s/R21\(.[0-9].[0-9]\{1,2\}\)/R21.$version/g" package/lean/default-settings/files/zzz-default-settings
...
sed -i "45i echo 'src/gz openwrt_ipk https://openwrt.download/ExtraPackages/mipsel_24kc' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
