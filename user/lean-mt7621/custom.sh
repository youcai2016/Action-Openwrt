...
sed  "46i echo 'src/gz openwrt_ipk https://openwrt.download/ExtraPackages/mipsel_24kc' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
