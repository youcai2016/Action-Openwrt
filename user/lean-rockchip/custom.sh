...
sed  "46i echo 'src/gz openwrt_ipk https://openwrt.download/ExtraPackages/aarch64_generic' >> /etc/opkg/customfeeds.conf " package/lean/default-settings/files/zzz-default-settings
